...
with tab_prediccio:
    ...
    with col1:
        ...
        oldbalanceOrig = st.number_input("Saldo origen abans", min_value=0.0, value=1000.0)
    ...
    with col2:
        ...
        newbalanceDest = st.number_input("Saldo destí després", min_value=0.0, value=1000.0)
